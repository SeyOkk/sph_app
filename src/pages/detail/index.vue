      ...
      <div class="mainCon">
        ...
        <div class="InfoWrap">
          <div class="goodsDetail">
            <h3 class="InfoName">{{ goodsInfo.skuName }}</h3>
...
export default {
  ...
  computed: {
    ...mapGetters(["categoryView", "goodsInfo", "spuSaleAttrList", "skuSaleAttrValueList"]),
    imgUrl() {
      if (this.imgList && this.imgList[this.imgUrlIndex]) {
        return this.imgList[this.imgUrlIndex].imgUrl;
      } else {
        return "";
      }
    },
